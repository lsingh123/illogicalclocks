...
python3 server.py -t tests/0.txt -id 2 -s 60 && python3 testeval.py -expected tests/0.txt
python3 server.py -t tests/1.txt -id 2 -s 60 && python3 testeval.py -expected tests/1.txt
